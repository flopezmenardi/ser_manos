...
// in ser_manos/test/mocks/news_service_mock.dart.
...
class MockNewsService extends _i1.Mock implements _i2.NewsService {
  ...
  @override
  _i3.Future<List<_i4.News>> getNewsOrderedByDate() =>
      (super.noSuchMethod(
            Invocation.method(#getNewsOrderedByDate, []),
            returnValue: _i3.Future<List<_i4.News>>.value(<_i4.News>[]),
          )
          as _i3.Future<List<_i4.News>>);

  @override
  _i3.Future<_i4.News?> getNewsById(String? id) =>
      (super.noSuchMethod(
            Invocation.method(#getNewsById, [id]),
            returnValue: _i3.Future<_i4.News?>.value(),
          )
          as _i3.Future<_i4.News?>);
}
